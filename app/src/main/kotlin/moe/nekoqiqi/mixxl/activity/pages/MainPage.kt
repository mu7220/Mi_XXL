...
class MainPage : BasePage() {
    ...
    override fun onCreate() {
        ...
        TextWithSwitch(TextV(textId = R.string.hide_desktop_icon), SwitchV("hide_desktop_icon", onClickListener = {
            ...
            pm.setComponentEnabledSetting(ComponentName(MIUIActivity.activity, moe.nekoqiqi.mixxl.activity.MainActivity::class.java.name + "Alias"), mComponentEnabledState, PackageManager.DONT_KILL_APP)
        }))
